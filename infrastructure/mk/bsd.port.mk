...
#
# The ports@fabbsd.org address is the `default' MAINTAINER (the generic
# FabBSD ports mailing-list).
...
ERRORS += "Please notify the FabBSD port maintainer:"
ERRORS += "    ${MAINTAINER}"
_BAD_LICENSING = Yes
...
# Documentation
MAINTAINER ?= The FabBSD ports mailing-list <ports@FabBSD.org>
	  ...
	  cd ${DISTDIR}; OK=true; list=''; \
		...
		if ! $$OK; then \
		  if ${REFETCH}; then \
			...
			echo "file from the FabBSD main archive, type"; \
